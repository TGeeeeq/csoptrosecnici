...
export default function LocationsView() {
  ...
  const vkpLocations = [
    ...
    },
    {
      ...
      description: t(
        "Tato lokalita zahrnuje listnaté lesíky a křovinaté stráně s významnými druhy, jako je krvavec toten — živná rostlina modráska bahenního a modráska očkovaného. VKP U osady je důležitým refugiem pro subtermofilní biotu a podporuje vysokou biodiverzitu. Výskyt druhů: hrušeň polnička, bradáček vejčitý, prvosenka jarní, žluva hajní.",
        "This site includes deciduous groves and shrubby slopes with significant species such as great burnet — the host plant of the dusky large blue and scarce large blue butterflies. VKP U osady is an important refuge for sub-thermophilic biota and supports high biodiversity. Species occurrence: wild pear, common twayblade, cowslip, and golden oriole.",
      ),
    },
    {
      icon: Flower2,
